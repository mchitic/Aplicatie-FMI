 ...
 * @author Mihai
 */
public class StateDeFunctiiV1 extends javax.swing.JFrame {

    /**
     * Creates new form StateDeFunctiiV1
     */
    public StateDeFunctiiV1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StateDeFunctiiV1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StateDeFunctiiV1().setVisible(true);
            }
        });
    }
